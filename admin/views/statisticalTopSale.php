                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="d-flex flex-column h-100">
                                        <h4 class="font-weight-bolder mb-0">Statistics Top Sale</h4>
                                    </div>
...
<script>
    ...
    function init_flot_chart(data = [0]) {
        ...
        var data = chart_plot_02_data.map(function(value, index) {
            return [index, value[1]]; // Use index as x value
        });
        var chart_plot_02_settings = {
            ...
            xaxis: {
                tickFormatter: function(val, axis) {
                    if (chart_plot_02_data[val] !== undefined) {
                        return chart_plot_02_data[val][0]; // Convert index back to product name
                    } else {
                        return '';
                    }
                },
                min: 0,
                max: chart_plot_02_data.length - 1,
            },
        };
