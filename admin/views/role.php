        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3>Users
                        <a href="add-role.php" class="btn btn-primary float-end"><i class="material-icons opacity-10">add</i>Add Role</a>
                    </h3>
                </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit-role.php?id=<?= $item['id']; ?>" class="btn btn-primary">Edit</a>
                                        </td>
                                        <td>
