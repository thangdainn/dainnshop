                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td style="min-width:7.3rem;"> <?= $item['sname']; ?> </td>

                                        <td style="min-width:7.3rem;"> <?= $item['quantity']; ?> </td>
                                        <td style="min-width:8.3rem;">
                                            <a href="edit-product-sizes.php?pid=<?= $item['product_id']; ?>&sid=<?= $item['size_id']; ?>" class="btn btn-success">Edit</a>
                                        </td>
                                    </tr>
                            <?php
                                }
